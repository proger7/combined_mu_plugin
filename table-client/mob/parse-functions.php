        ...
        if ($style == 'style1') {
            ...
            return $tableHTML;
                ...
                foreach ($filteredOffersArray as $arr_key => $offer) {
                    ...
                    $fullStars = $randomScore >= 9.0 ? 5 : ($randomScore >= 8.0 ? 4 : ($randomScore >= 7.0 ? 3 : 2));

                    for ($i = 0; $i < 5; $i++) {
                        $tableHTML .= '<span data-v-d9c24a74="" class="' . ($i < $fullStars ? 'ad_wbc_full' : 'ad_wbc_empty') . '"></span>';
                    }
                    ...
                    $tableHTML .= '<div class="ad_wbc_women" data-v-de82ba65="">&nbsp;' . esc_html($offer['genderRatingFemale']) . '</div>';
                    $tableHTML .= '</div>';
                    $tableHTML .= '</div>';
                    $tableHTML .= '</div>';
                    $tableHTML .= '</div>';
