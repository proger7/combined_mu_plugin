...
if ( ! function_exists( 'customDisplayCasinoTables' ) ) {
    function customDisplayCasinoTables($atts) {

        $data = include __DIR__ . '/casino-offers-data.php';
        ...
        enqueue_casino_table_css($style);
...
add_shortcode('display_casino_tables', 'customDisplayCasinoTables');

if ( ! function_exists( 'enqueue_casino_table_css' ) ) {
    function enqueue_casino_table_css($style) {
        $handle = "casino-table-css-$style";
